        ...
        filteredOrders.map((order) =>
          order.products.map((product, idx) => (
            <div
              ...
              className="card mb-3 shadow-sm border-0"
            >
              <div className="card-body d-flex flex-column flex-md-row justify-content-between align-items-center align-items-md-start">
                {/* Left: Image */}
                <img
                  src={product.image || "https://via.placeholder.com/80"}
                  alt={product.name}
                ...
                <div className="flex-grow-1 text-center text-md-start mb-3 mb-md-0">
                  <h6
                    className="mb-1 text-truncate mx-auto mx-md-0"
                    style={{ maxWidth: "300px" }}
                  >
                    {product.name}
                  </h6>
